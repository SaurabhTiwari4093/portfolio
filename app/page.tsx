...
function Home() {
  return (
    <>
      <Head>
        <title>Saurabh Tiwari | Home</title>
      </Head>
      <main className="grid grid-cols-3 gap-4 mb-4">
        <div className="col-span-3 md:col-span-2 bg-gradient-to-b from-white to-gray-100 rounded shadow border p-4">
          ...
          <div className="text-gray-500 text-justify text-sm md:text-base">
            ...
            <p>
              Beyond technical achievements, I have assumed pivotal roles such
              as Core Team Member (Tech) for BECON (IITD E-Summit), overseeing
              the registration portal for over 7000 students and spearheading
              the launch of the Campus Ambassador website. As the Technical
              ...
              discover the various facets of my professional journey, and do not
