      ...
      <main className="grid grid-cols-3 gap-4 mb-4">
        <div className="col-span-3 md:col-span-2 bg-gradient-to-b from-white to-gray-100 rounded shadow border p-4">
          ...
          <div className="text-gray-500 text-justify text-sm md:text-base">
            <p className="mb-3">
              Hello! I am Saurabh Tiwari, a dynamic software developer
              and a final-year undergraduate student at the Indian Institute of
            ...
            <p>
              Beyond technical achievements, I have assumed pivotal roles
              such as Core Team Member (Tech) for BECON (IITD E-Summit),
              overseeing the registration portal for over 7000 students and
              spearheading the launch of the Campus Ambassador website. As the
              Technical Coordinator for the Entrepreneurship Development Cell
              (eDC), I designed and managed the EDC IIT Delhi website, also
              facilitating industry-academia collaborations through an
              innovative opportunity portal. Proficient in front-end and
              back-end technologies like HTML, CSS, JavaScript, ReactJs, NodeJs,
              ExpressJs, MongoDB, and more. My journey in software development
              is complemented by a Silver Medal in Cricket at the IIT Premier
              League, highlighting my commitment to sportsmanship and teamwork.
              Explore my portfolio to discover the various facets of my
              professional journey, and do not hesitate to reach out for
