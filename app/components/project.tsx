...
function Project(props: any) {
  return (
    <div className="col-span-2 md:col-span-1 rounded shadow bg-white border">
      <Image src={props.image} alt={props.title} className="w-full h-100 rounded-t" />
      <div className="p-4">
        ...
        <div className="flex gap-4 items-center justify-center text-gray-600 text-sm">
          {props.href !== "#" ? (
            <Link href={props.href} target="_blank" rel="noopener noreferrer">
              <button className="bg-gray-50 hover:bg-gray-100 rounded-full shadow border font-semibold py-1.5 px-6 flex gap-1 items-center justify-center">
